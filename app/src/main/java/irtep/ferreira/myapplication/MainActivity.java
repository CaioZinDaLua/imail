package irtep.ferreira.myapplication;
        ...
        btnEnviar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    //Tentando ativar a intenção pesquisando por apps compativeis para a ação SEND TO
                }
                catch (ActivityNotFoundException e){
                    Toast.makeText(MainActivity.this, "Não há nenhum APP que possa realizar essa ação",
                            Toast.LENGTH_LONG).show();
                    //Mostrando mensagem para avisar que não há nenhum app para a ação e terminei
